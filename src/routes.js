...
const Appointment = React.lazy(() => import('./views/appointment/index'))
const Treatment = React.lazy(() => import('./views/treament'))
...
const routes = [
  ...
  { path: '/treatment', name: 'Appointment', component: Treatment },
